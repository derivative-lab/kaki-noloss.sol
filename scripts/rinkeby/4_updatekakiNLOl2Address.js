...
const kakiFrontEntranceProxy = require("../../.openzeppelin/rinkeby.json").proxies[0].address;
const kakiNLO_L2_ADD = require("../../.openzeppelin/unknown-421611.json").proxies[0].address;
